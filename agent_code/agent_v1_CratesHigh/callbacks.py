...
def mappping(self):
        ...
        for v in vec_dir:
            ...
            for i in range(4):
                ...
                if ((0 < xcoord < arena.shape[0]) and
                    ...
                    bomb_map_timer[(xcoord, ycoord)] = 1
    ...
    for i in range(4):
        d = directions[i]
        if (arena[d] == 0 and explosion_map[d] <= 1 and not d in bombs_xy):
            valid[i] = 1
...
def setup(self):
    ...
    #MODEL
    self.model_path = './agent_code/agent_v1_CratesHigh/model.h5'
